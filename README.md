...
| :--- | :--- | :--- |
| **Windows 10 / 11 Installer** | [**⬇️ Download Aether-Setup.exe (Direct CDN)**](https://github.com/RekapalliVasudeva-MBU/aether-desktop/releases/download/v1.0.0/Aether-Setup.exe) | **Standalone One-Click Setup** — Auto-creates Desktop & Start Menu shortcuts |
